...
function DashboardPage() {
    _s();
    const { user, isSuperAdmin, loading: authLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
                ...
                "DashboardPage.useEffect.fetchData": async ()=>{
                    try {
                        ...
                        const [vehiclesResult, alertsResult, driversResult, trackingResult] = await Promise.all([
                            ...
                            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("drivers").select("id").or(orFilter),
                            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("tracking_data").select("speed, distance, vehicle_id, timestamp, address, last_known_address").or(orFilter).order("timestamp", {
                                ascending: false
                            }).limit(20)
                        ]);
...
_s(DashboardPage, "V0QLib4bHnLx11n6AaZwtHfWHM8=", false, function() {
    return [
...
//# sourceMappingURL=_11efd9d8._.js.map