...
function SettingsPage() {
    _s();
    const { user, role, isSuperAdmin, isOwner, isDriver } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const [alertSettings, setAlertSettings] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        ...
        "SettingsPage.useEffect": ()=>{
            ...
            const fetchProfile = {
                "SettingsPage.useEffect.fetchProfile": async ()=>{
                    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('*').eq('id', user.id).maybeSingle();
                    if (data && !error) {
                        setProfile(data);
                        setFormData({
                        ...
                        const { data: newProfile } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').insert([
                            {
                                id: user.id,
                                email: user.email
                            }
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').update(updateData).eq('id', user.id);
            if (error) {
                ...
                if (data) {
                    setProfile(data);
                    // keep form data in sync with saved profile
                    setFormData({
                        full_name: data.full_name || '',
                        company_name: data.company_name || '',
                        phone: data.phone || ''
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        message && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: `mb-6 p-3 rounded-lg ${message.includes('success') ? 'bg-green-500/10 border border-green-500/50 text-green-400' : 'bg-red-500/10 border border-red-500/50 text-red-400'}`,
                            children: message
                        }, void 0, false, {
                            fileName: "[project]/app/(dashboard)/settings/page.tsx",
                            lineNumber: 138,
                        ...
                        !isEditing ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            lineNumber: 151,
                            columnNumber: 13
                        }, this) : /* Editable form when in edit mode */ /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: `inline-block px-3 py-1 text-sm font-medium rounded-full mt-1 ${isSuperAdmin ? 'bg-purple-500/10 text-purple-400' : isOwner ? 'bg-blue-500/10 text-blue-400' : isDriver ? 'bg-green-500/10 text-green-400' : 'bg-slate-700 text-slate-300'}`,
                                            children: isSuperAdmin ? 'Super Admin' : isOwner ? 'Owner' : isDriver ? 'Driver' : role || 'User'
                                        }, void 0, false, {
                                            fileName: "[project]/app/(dashboard)/settings/page.tsx",
                                            lineNumber: 278,
                                            columnNumber: 15
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "text-white font-mono text-sm",
                                            children: profile?.company_id || 'N/A'
                                        }, void 0, false, {
                                            fileName: "[project]/app/(dashboard)/settings/page.tsx",
                                            lineNumber: 301,
                                            columnNumber: 15
                            ...
                            children: [
                                {
                                    ...
                                    desc: 'Notify when vehicles enter/exit geofences'
                                },
                                {
                                    key: 'speed_alerts',
                                    label: 'Speed Alerts',
                                    desc: 'Notify when vehicles exceed speed limits'
                                },
                                {
                                    key: 'sos_alerts',
                                    label: 'SOS Alerts',
                                    desc: 'Notify on emergency SOS triggers'
                                },
                                {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            ...
                                            className: `w-12 h-6 rounded-full transition-colors relative ${alertSettings[key] ? 'bg-blue-500' : 'bg-slate-600'}`,
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: `absolute top-1 w-4 h-4 rounded-full bg-white transition-all ${alertSettings[key] ? 'right-1' : 'left-1'}`
                                            }, void 0, false, {
                                                fileName: "[project]/app/(dashboard)/settings/page.tsx",
                                                lineNumber: 330,
                                                columnNumber: 19
...
_s(SettingsPage, "5rqsv0qng1gX3EvMA2AA/+K4GKk=", false, function() {
    return [
...
//# sourceMappingURL=_c084d88f._.js.map