...
"[project]/app/(dashboard)/global-vehicles/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function GlobalVehiclesPage() {
    ...
    const fetchAllVehicles = async ()=>{
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("vehicles").select("*").order("created_at", {
            ascending: false
        });
        ...
        "GlobalVehiclesPage.useEffect": ()=>{
            ...
            if (searchTerm) {
                filtered = filtered.filter({
                    "GlobalVehiclesPage.useEffect": (v)=>(v.tracker_id?.toLowerCase() || "").includes(searchTerm.toLowerCase()) || (v.registration_number?.toLowerCase() || "").includes(searchTerm.toLowerCase()) || (v.brand?.toLowerCase() || "").includes(searchTerm.toLowerCase()) || (v.model?.toLowerCase() || "").includes(searchTerm.toLowerCase())
                }["GlobalVehiclesPage.useEffect"]);
            }
            if (statusFilter !== "all") {
                filtered = filtered.filter({
                    "GlobalVehiclesPage.useEffect": (v)=>v.status === statusFilter
                }["GlobalVehiclesPage.useEffect"]);
            }
            if (typeFilter !== "all") {
                filtered = filtered.filter({
                    "GlobalVehiclesPage.useEffect": (v)=>v.vehicle_type === typeFilter
                }["GlobalVehiclesPage.useEffect"]);
            }
...
_s(GlobalVehiclesPage, "4+X0YiXE8Npi6fJljhOEe4323lg=", false, function() {
    return [
...
_c = GlobalVehiclesPage;
var _c;
__turbopack_context__.k.register(_c, "GlobalVehiclesPage");
...
//# sourceMappingURL=_4a44ae69._.js.map